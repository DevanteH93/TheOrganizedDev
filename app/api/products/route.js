...
export async function GET() {
    try {
        // fetch all the acrtive products from stripe
        const products = await stripe.products.list({
            active: true,
        });

        // fetch all the prices that are active from stripe
        ...
        return Response.json({ error: 'Failed to fetch datat from stripe' });
    }
}
