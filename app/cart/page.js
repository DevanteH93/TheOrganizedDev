// MAKE A CODE THAT TOTALS UP THE OVERALL VALUE OF ALL THE PRODUCTS AT THE CHECK OUT PAGE
...
// the code below -(Object.keys)- was broken do to not calling the hook '()' after useProducts
  ...
  return (
    <section className="cart-section">
      ...
      <div className="cart-container">
        {/* changed the code below to the current one, to fix the error and load out the cart.page */}
